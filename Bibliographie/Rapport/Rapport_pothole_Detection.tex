...
% Page de couverture
\includepdf[pages=1]{COUVERTURE1.pdf}
...
Le notebook est accessible à l'adresse : \url{https://github.com/VirlenceDongmo/Pothole_Detection/blob/master/Code/pothole_notebook/Pothole_detection.ipynb}
...
L'image suivante représente la page d'accueil de cette application.


\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{img/page_accueil.png}
\caption{Page d'accueil de l'application flask pour le déploiement du modèle de détection de nids de poules sur le tronçon Dschang-Bafoussam}
\end{figure}


\subsection{Perspective d'amélioration}
\begin{itemize}
...
\subsection{Lien d'accès au projet}

\textbf{Le dossier complet du projet est accessible à l'adresse : \href{https://github.com/VirlenceDongmo/Pothole_Detection}{\faGithub \quad VirlenceDongmo / Pothole\_Detection}
}
